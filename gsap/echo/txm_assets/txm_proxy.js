//TXM Proxy v1.2 | (c) 2020 Joystick Interactive
...
TXM.dispatcher = {
	...
	"START_ENGAGEMENT" : new CustomEvent("START_ENGAGEMENT"),
	...
	onAssetsReady : function(event){
		...
		//TXM.dispatcher.dispatchEvent("START_ENGAGEMENT");
		
	},
	
	onEngagementAssetLoadingProgress: function(event){
		let perc = Math.round(event.detail*100);
		console.log("loading "+perc+"%");
		
		if(perc >= 100) TXM.dispatcher.dispatchEvent("START_ENGAGEMENT");
	}
